...
\date{3-Dec-2019}% 1st arxiv version finished
...
\begin{cadabra}
   ...
   evaluate   (Gamma, gab+iab, rhsonly=True)                 |\lstlabel{ex-06.204}|
   evaluate   (Rabcd, gab+iab, rhsonly=True)                 |\lstlabel{ex-06.205}|
\end{cadabra}
