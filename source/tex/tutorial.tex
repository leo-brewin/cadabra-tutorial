...
% --------------------------------------------------------------------------------------------
% pdflatex paper
% biber --decodecharsset=null paper
% pdflatex paper
% pdflatex paper
% --------------------------------------------------------------------------------------------
...
%    First  solution use: biber paper and \usepackage[latin1]{inputenc}
%    Second solution use: biber --decodecharsset=null paper
...
\input{../cadabra/example-05.cdbtex}
...
\input{../cadabra/example-01.cdbtex}
...
\Note{I think there is a bug when adding rules that contain single elements.
      See {\tts ../cadabra/bugs/lcb11}}
...
\input{../cadabra/example-02.cdbtex}
...
\input{../cadabra/example-03.cdbtex}
...
\input{../cadabra/example-04.cdbtex}
...
\input{../cadabra/example-06.cdbtex}
...
\input{../cadabra/example-07.cdbtex}
...
\input{../cadabra/example-08.cdbtex}
...
\begin{cadabra}
   ...
   from cadabra2 import *                           |\lstlabel{ex:8.02}|
...
\input{../cadabra/example-09.cdbtex}
...
\input{../cadabra/example-10.cdbtex}
...
\input{../cadabra/example-11.cdbtex}
...
\input{../cadabra/example-12.cdbtex}
...
\input{../cadabra/example-13.cdbtex}
...
\input{../cadabra/example-14.cdbtex}
...
\input{../cadabra/example-15.cdbtex}
...
\Note{Check: Do I derive all the constraint equations? No, not as a single file but I have
used versions of the Hamiltonian in eqtns11.tex and eqtns12.tex. I will create a new file
just for the Hamiltonian.}
